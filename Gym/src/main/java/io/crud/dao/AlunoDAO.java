...
import java.sql.*;
import io.crud.factory.*;
import java.text.ParseException;
import java.text.SimpleDateFormat;
import java.util.Date;
import java.util.ArrayList;
import java.util.List;
import io.crud.modelo.*;

public class AlunoDAO {
    
    private Connection connection;
    private HistoricoPesoDAO daoHistorico;
    
    public AlunoDAO(){
        this.connection = new ConnectionFactory().getConnection();
        this.daoHistorico = new HistoricoPesoDAO();
    }
    ...
    public int excluir(int codigo){
        ...
        List<HistoricoPeso> listaDeHistoricos = daoHistorico.consultaByAluno(codigo);
        List<Integer> listaDeIdHistoricos = new ArrayList<>();
        for(HistoricoPeso hp : listaDeHistoricos){
            listaDeIdHistoricos.add(hp.getId());
        }
        List<Integer> resultadoHistorico = daoHistorico.excluirVarios(listaDeIdHistoricos);
